...
const videos = [
  'https://www.youtube.com/watch?v=https://www.youtube.com/watch?v=Yc7VaHsZnR0', 
  
  'https://www.youtube.com/watch?v=https://youtu.be/DmkH24py520', 
  'https://youtu.be/DmkH24py520'
];
      ...
      <div className="notice-board">
         <div className="circulars-board">
          <div className="header">
            <h2>CIRCULARS</h2>
            <a href="/all-circulars">All Circulars</a>
          </div>
