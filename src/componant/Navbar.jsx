...
{/* Admission Section */}
            ...
            <li className={`dropdown ${activeDropdown === 'departments' ? 'active' : ''}`}>
              <div className="nav-link-wrapper" onClick={() => toggleDropdown('departments')}>
                ...
                <button className="dropdown-toggle" aria-label="Toggle departments menu">
              ...
              <ul className="dropdown-menu">
                ...
                <li><NavLink to="/departments/exam" activeClassName="active" onClick={handleLinkClick}>Exam Cell</NavLink></li>
            ...
            <li className={`dropdown ${activeDropdown === 'student-corner' ? 'active' : ''}`}>
              ...
              <ul className="dropdown-menu">
                <li><NavLink to="/student-corner/calendar" activeClassName="active" onClick={handleLinkClick}>Academic Calendar</NavLink></li>
                <li><NavLink to="/student-corner/curriculum" activeClassName="active" onClick={handleLinkClick}>Curriculum</NavLink></li>
                <li><NavLink to="/student-corner/first-year" activeClassName="active" onClick={handleLinkClick}>First Year Curriculum 2023</NavLink></li>
                <li><NavLink to="/student-corner/question" activeClassName="active" onClick={handleLinkClick}>Question Papers</NavLink></li>
                <li><NavLink to="/student-corner/maha" activeClassName="active" onClick={handleLinkClick}>MAHA DBT</NavLink></li>
                <li><NavLink to="/student-corner/vidyalakshmi" activeClassName="active" onClick={handleLinkClick}>Vidyalakshmi Portal</NavLink></li>
                <li><NavLink to="/student-corner/exam-rules" activeClassName="active" onClick={handleLinkClick}>Examination Rules</NavLink></li>
                <li><NavLink to="/student-corner/malpractice" activeClassName="active" onClick={handleLinkClick}>Examination Malpractice and Punishments</NavLink></li>
                <li><NavLink to="/student-corner/scholars" activeClassName="active" onClick={handleLinkClick}>Our Scholars</NavLink></li>
                <li><NavLink to="/student-corner/e-content" activeClassName="active" onClick={handleLinkClick}>E-Content</NavLink></li>
                <li><NavLink to="/student-corner/video" activeClassName="active" onClick={handleLinkClick}>Video Lectures</NavLink></li>
              </ul>
            </li>
            ...
            <li className={`dropdown ${activeDropdown === 'tpo' ? 'active' : ''}`}>
              <div className="nav-link-wrapper" onClick={() => toggleDropdown('tpo')}>
                <NavLink to="/tpo" activeClassName="active">
            ...
            <li className={`dropdown ${activeDropdown === 'cdc' ? 'active' : ''}`}>
              <div className="nav-link-wrapper" onClick={() => toggleDropdown('cdc')}>
                <NavLink to="/cdc" activeClassName="active">
